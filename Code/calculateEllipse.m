function calculateEllipse(parameters, H , sigma_squared , UE)
% input k is the k-sigma ellipse value (e.g., k=3 sigma)

% CRB
C = sigma_squared*inv(H'*H);
...
%plot3(ellipsePoints(1,:),repmat(UE(2), length(ellipsePoints(3,:))),ellipsePoints(3,:))
